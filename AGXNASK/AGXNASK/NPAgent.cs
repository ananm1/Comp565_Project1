...
public class NPAgent : Agent {
   ...
   private List<NavNode> makePath() {
      ...
      aPath.Add(new NavNode(new Vector3(105 * spacing, stage.Terrain.surfaceHeight(105, 495), 495 * spacing),
               NavNode.NavNodeEnum.WAYPOINT));
      aPath.Add(new NavNode(new Vector3(30 * spacing, stage.Terrain.surfaceHeight(100, 50), 230 * spacing),
          NavNode.NavNodeEnum.WAYPOINT));
      aPath.Add(new NavNode(new Vector3(50 * spacing, stage.Terrain.surfaceHeight(100, 50), 400 * spacing),
          NavNode.NavNodeEnum.WAYPOINT));
      aPath.Add(new NavNode(new Vector3(250 * spacing, stage.Terrain.surfaceHeight(100, 50), 250 * spacing),
          NavNode.NavNodeEnum.WAYPOINT));
      aPath.Add(new NavNode(new Vector3(305 * spacing, stage.Terrain.surfaceHeight(100, 50), 450 * spacing),
          NavNode.NavNodeEnum.WAYPOINT));
      // */ shorter path tests
      return(aPath);
   }
